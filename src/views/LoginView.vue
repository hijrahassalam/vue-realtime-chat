<template>
  <div class="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-primary-50 via-white to-primary-100">
    ...
    <div class="fixed inset-0 overflow-hidden pointer-events-none">
      <div class="absolute -top-40 -right-40 w-80 h-80 bg-primary-200 rounded-full blur-3xl opacity-30 animate-pulse-soft" />
      <div class="absolute -bottom-40 -left-40 w-80 h-80 bg-primary-300 rounded-full blur-3xl opacity-20 animate-pulse-soft" style="animation-delay: 1s" />
    </div>
    ...
    <div class="w-full max-w-md animate-fade-in">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-sm text-gray-500 mt-1">Sign in to continue to ChatFlow</p>
      </div>
